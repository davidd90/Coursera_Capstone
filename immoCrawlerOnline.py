...
while(True):
    ...
    print(str(datetime.now()) + "Loop startet.")
    try:
        soup = bs.BeautifulSoup(urllib.request.urlopen('https://www.immobilienscout24.de/Suche/de/sachsen/leipzig/wohnung-mieten').read(),'lxml')
        l=[]
        ...
        print(str(datetime.now())+": " + str(e)) 
    print(str(datetime.now())+"Loop endet.")
    time.sleep(3600)
print("FERTIG!")
